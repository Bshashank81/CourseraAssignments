...
public class BasicDocument extends Document 
{
	...
	{
		int numOfWords = getTokens("[a-zA-Z]+").size();
		return numOfWords;
	}
	...
	{
	    int numOfSentences = getTokens("[^.!?]+").size();
	...
	public int getNumSyllables()
	{
		...
		{
			int currSyllablesCount = countSyllables(wordList.get(i));
			total = total + currSyllablesCount;
		}
        return total;
	}
	...
	public static void main(String[] args)
	{
		 ...
		 */
		BasicDocument bObj = new BasicDocument("This is a test.  How many???  \"\r\n" + 
				"		        + \"Senteeeeeeeeeences are here... there should be 5!  Right?");
		double fleschScore = bObj.getFleschScore();
		System.out.println("The flesch score is "+fleschScore);
